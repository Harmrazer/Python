...
class TownCar(Car):
    ...
    def show_speed(self):
        if self.speed > 60:
            print(f'Внимание! Превышение скорости {self.speed-60} км/ч')
        else:
            print(f'Скорость {self.speed} км/ч')
...
class WorkCar(Car):
    ...
    def show_speed(self):
        if self.speed > 40:
            print(f'Внимание! Превышение скорости {self.speed-40} км/ч')
        else:
            print(f'Скорость {self.speed} км/ч')
...
polo = TownCar('Серебристый', 'Toyota Alphard')
test_drive(polo)

veyron = SportCar('Желтый', 'Chevrolet Camaro')
test_drive(veyron)

largus = WorkCar('Синий', 'Ford Mondeo')
test_drive(largus)

mondeo = PoliceCar('Белый', 'Dodge Charger')
test_drive(mondeo)